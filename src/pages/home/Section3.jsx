...
const Section3 = () => {
  ...
  return (
    <section className="section3 h-screen flex justify-center items-center">
      <div className="container">
        <div className="flex flex-col md:flex-row justify-center items-center -mt-10">
          <div className="flex-1 flex flex-col justify-center items-center md:items-start md:pl-5">
            <h2 className="text-4xl sm:text-6xl md:text-5xl lg:text-6xl xl:text-7xl mb-10 font-bold text-center md:text-left">이민성 님의</h2>
            <h2 className="text-4xl sm:text-6xl md:text-5xl lg:text-6xl xl:text-7xl mb-10 font-bold text-center md:text-left">여행 계획 플랫폼</h2>
          ...
          <div className="flex-1 items-center justify-center hidden md:flex">
            <button onClick={PicClick}>
              <div className="image-container">
                <img
                  src={`${process.env.PUBLIC_URL}/planner.webp`}
                  alt="여행"
